...
## [0.7.0](https://github.com/alex-snezhko/grain/compare/stdlib-v0.6.0...stdlib-v0.7.0) (2024-03-10)


### ⚠ BREAKING CHANGES

* **stdlib:** Replace `parseInt` error strings with structured error enum ([#1755](https://github.com/alex-snezhko/grain/issues/1755))
* **stdlib:** Move stdlib `sys` modules to `wasi` ([#2056](https://github.com/alex-snezhko/grain/issues/2056))
* **compiler:** Remove arbitrary per-file compiler flags, add acceptable options as module attributes ([#1804](https://github.com/alex-snezhko/grain/issues/1804))
* **compiler:** Require extension when including relative file paths ([#1842](https://github.com/alex-snezhko/grain/issues/1842))
* **compiler:** Update include syntax ([#2043](https://github.com/alex-snezhko/grain/issues/2043))
* **stdlib:** Remove `sin`, `cos`, `tan`, `gamma`, `factorial` from `Number` module ([#2046](https://github.com/alex-snezhko/grain/issues/2046))
* **compiler:** Update use syntax ([#2041](https://github.com/alex-snezhko/grain/issues/2041))
* **grainfmt:** Implement new formatter ([#1976](https://github.com/alex-snezhko/grain/issues/1976))
...
* **compiler:** Remove arbitrary per-file compiler flags, add acceptable options as module attributes ([#1804](https://github.com/alex-snezhko/grain/issues/1804)) ([72b2139](https://github.com/alex-snezhko/grain/commit/72b21393b0c82669ff9005730cafb0b345a8a992))
...
* **compiler:** Require extension when including relative file paths ([#1842](https://github.com/alex-snezhko/grain/issues/1842)) ([dde62d3](https://github.com/alex-snezhko/grain/commit/dde62d39c501bd25cccac6569b426406711a5735))
...
* **compiler:** Update include syntax ([#2043](https://github.com/alex-snezhko/grain/issues/2043)) ([5f44d4e](https://github.com/alex-snezhko/grain/commit/5f44d4e5a1cd432faddcfb1a138ac6a7797423fd))
* **compiler:** Update use syntax ([#2041](https://github.com/alex-snezhko/grain/issues/2041)) ([cd346ab](https://github.com/alex-snezhko/grain/commit/cd346ab761aaa5e8e7692ebce1bae4e5e7e47f45))
...
* **grainfmt:** Implement new formatter ([#1976](https://github.com/alex-snezhko/grain/issues/1976)) ([1568aa0](https://github.com/alex-snezhko/grain/commit/1568aa06f625c4d91d9151e3f969ec648e8d4231))
...
* **stdlib:** Add `atan2` to the `Number` module ([#2016](https://github.com/alex-snezhko/grain/issues/2016)) ([145b783](https://github.com/alex-snezhko/grain/commit/145b783f234d9f6d6bdbe730877a5a53d125cb93))
...
* **stdlib:** Add `Json` module ([#1133](https://github.com/alex-snezhko/grain/issues/1133)) ([5a6e4c6](https://github.com/alex-snezhko/grain/commit/5a6e4c6111ff84b3249436d485d4c45ef0a89d61))
...
* **stdlib:** Add `Uri` module ([#1970](https://github.com/alex-snezhko/grain/issues/1970)) ([5cf726e](https://github.com/alex-snezhko/grain/commit/5cf726edb06ef42a9c8c073fbd3407defe501a49))
...
* **stdlib:** Move stdlib `sys` modules to `wasi` ([#2056](https://github.com/alex-snezhko/grain/issues/2056)) ([ca75e38](https://github.com/alex-snezhko/grain/commit/ca75e38a2bbadd1a5e51f7ab344994d62c96ca4f))
...
* **stdlib:** Ensure consistent marshal representation ([#2045](https://github.com/alex-snezhko/grain/issues/2045)) ([029059f](https://github.com/alex-snezhko/grain/commit/029059fbeed185a2e467a014bbc313fda4b87c5e))
...
* **stdlib:** Error when `relativeTo` used on relative source and absolute dest ([#2054](https://github.com/alex-snezhko/grain/issues/2054)) ([1626a1f](https://github.com/alex-snezhko/grain/commit/1626a1fd8b621c6bcc359dab48b4495a0db21e14))
...
* **stdlib:** Remove `sin`, `cos`, `tan`, `gamma`, `factorial` from `Number` module ([#2046](https://github.com/alex-snezhko/grain/issues/2046)) ([85c4389](https://github.com/alex-snezhko/grain/commit/85c4389dee9f0760e40639df5112294cb4cc44cb))
...
* **stdlib:** Replace `parseInt` error strings with structured error enum ([#1755](https://github.com/alex-snezhko/grain/issues/1755)) ([ea26d18](https://github.com/alex-snezhko/grain/commit/ea26d1814558730507517d4939abed6767aaaf24))
